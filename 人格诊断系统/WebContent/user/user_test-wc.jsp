             ...
             <table width="800px" align="center" height="90%" style="margin-top:100px;">
                <tbody>
                    <tr>
                        ...
                        <td width="394" height="106" align="left" valign="bottom"><span style="font-size:20px;">症状信息填写完成：</span></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top"><div style="font-size:20px;width:145px;height:100px;">&nbsp;&nbsp;&nbsp;&nbsp;敬请等待医生处理</div></td>
                    </tr>
                </tbody>
            </table>
