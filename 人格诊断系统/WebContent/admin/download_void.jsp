...
<ul class="layui-tab-title">
  <li><a href="<%=request.getContextPath() %>/admin/download_pic.jsp">心理图片管理</a></li>
  <li><a href="<%=request.getContextPath() %>/admin/download_book.jsp">心理书籍管理</a></li>
  <li class="layui-this"><a href="<%=request.getContextPath() %>/admin/download_void.jsp">心理视频管理</a></li>
</ul>
<div class="layui-tab-content" >
  <div class="layui-tab-item layui-show">
    ...
    <div class="tools">
    <ul class="toolbar">
      <li onclick="download_picadd('添加信息','<%=request.getContextPath() %>/admin/download_voidadd.jsp','600','500')"><span><img src="<%=request.getContextPath() %>/images/t01.png" /></span>添加</li>
    ...
    <table class="tablelist">
      ...
      <tbody id="x-img">
        <tr>
          ...
          <td class="td-manage"><a title="修改" href="javascript:;" onclick="download_picedit('修改','<%=request.getContextPath() %>/admin/download_voidedit.jsp','4','','510')"
        ...
        <tr>
          <td><input type="checkbox" value="1" name="selected"></td>
          <td width="7%">心理视频</td>
          <td align="center" width="7%"><img src="<%=request.getContextPath() %>/images/void.jpg" alt="" width="56" height="56"></td>
          <td >2017-07-15</td>
          <td >叙述内容</td>
          <td class="td-status"><button class="sp">已上传</button></td>
          <td class="td-manage"> <a title="修改" href="javascript:;" onclick="download_picedit('修改','download_voidedit.jsp','4','','510')"
                            class="ml-5" style="text-decoration:none"> <i class="layui-icon">&#xe642;</i> </a> <a title="删除" href="javascript:;" onclick="banner_del(this,'1')" 
                            style="text-decoration:none"> <i class="layui-icon">&#xe640;</i> </a></td>
        </tr>
      </tbody>
