...
<script language="JavaScript" src="<%=request.getContextPath() %>/js/jquery2.js"></script>
...
<div class="loginbody"> <span class="systemlogo"></span>
  <div class="loginbox">
    <ul>
      ...
      <li>
        <input name="" type="text" class="loginy" placeholder="输入验证码"/><label><img src="<%=request.getContextPath() %>/images/images.jpg" /></label>
      </li>
      <li>
        <input name="" type="button" class="loginbtn" value="登录"  onclick="javascript:window.location='<%=request.getContextPath() %>/admin/index.jsp'"  />
      </li>
    </ul>
  </div>
</div>
